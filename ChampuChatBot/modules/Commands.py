...
from ChampuChatBot.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@ChampuChatBot.on_message(filters.command(["lang", "language", "setlang"]))
...
@ChampuChatBot.on_message(filters.command("status"))
...
@ChampuChatBot.on_message(filters.command(["resetlang", "nolang"]))
...
@ChampuChatBot.on_message(filters.command("chatbot"))
