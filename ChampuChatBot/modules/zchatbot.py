...
from ChampuChatBot.mplugin.helpers import chatai, CHATBOT_ON, languages
...
@ChampuChatBot.on_message(filters.incoming)
async def chatbot_response(client: Client, message: Message):
    ...
    try:
        ...
        if (message.reply_to_message and message.reply_to_message.from_user.id == ChampuChatBot.id) or not message.reply_to_message:
